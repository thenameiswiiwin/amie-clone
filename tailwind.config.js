  ...
  theme: {
    ...
    backgroundImage: {
      "feature-gradient-conic":
        "conic-gradient(from 90deg at 80% 50%, #000212, rgb(var(--feature-color-dark))), conic-gradient(from 270deg at 20% 50%, rgb(var(--feature-color-dark)), #000212)",
      "feature-gradient-radial":
